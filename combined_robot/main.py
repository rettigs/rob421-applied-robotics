...
def usage():
    ...
    print '\t-m\tspecify the main video capture device to use, defaults to "/dev/video0"'
    print '\t-b\tspecify the bounce shot video capture device to use, defaults to "/dev/video1"'
...
if __name__ == '__main__':
    ...
    mainCaptureDevice = '0'
    bounceCaptureDevice = '0'

    # Parse arguments
    try:
        opts, args = getopt.getopt(sys.argv[1:], "s:m:b:dvh")
    ...
    App(mainCaptureDevice, bounceCaptureDevice, robotq, appq, launchspeed).run()
